...
* @{
*/
#define PRODUCT_KEY "ff4dfd7738f944f09958d6647308f902"
/**@} */
/**@name Product Secret (产品密钥)
* @{
*/
#define PRODUCT_SECRET "74abd704935f46c2846207538ea70cbe"
/**@} */
...
#define gps_jingdu_RATIO                         1
#define gps_jingdu_ADDITION                      0
#define gps_jingdu_MIN                           0
#define gps_jingdu_MAX                           99999999
#define gps_weidu_RATIO                         1
#define gps_weidu_ADDITION                      0
#define gps_weidu_MIN                           0
#define gps_weidu_MAX                           99999999
#define gps_speed_RATIO                         1
#define gps_speed_ADDITION                      0
#define gps_speed_MIN                           0
#define gps_speed_MAX                           99999999
...
//以下为修改
typedef_t struct {
  uint32_t valuegps_jingdu;
  uint32_t valuegps_weidu;
  uint32_t valuegps_speed;
} dataPoint_t;
...
//以下为修改
typedef_t struct {
  uint8_t flaggps_jingdu:1;
  uint8_t flaggps_weidu:1;
} attrFlags_t;
